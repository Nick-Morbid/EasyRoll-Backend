...
public class CustomHttpServletRequest implements HttpServletRequest {
    ...
    public CustomHttpServletRequest setSession(javax.websocket.Session session){
        this.session = new Session().setId(session.getId());
        return this;
    }

    public CustomHttpServletRequest setHeader(String header,String value){
